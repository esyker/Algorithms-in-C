...
Before each puzzle you enter the puzzle dimensions followed by a number (1 or 2) that represents the restritions you want for the program.
...
pair, also). If you choose 1, this condition won't need to be satisfied. Note that the standar binary puzzle has this restrition, this is,
if you want to solve the binary puzzle according to the standar rules you should use this restrition ( write a 2 after the maatrix 
dimensions).
